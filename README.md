A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Create Queued Callback
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-create-queued-callback-data-action-module.git?ref=v1.0.0"
    action_name        = "Create Queued Callback"
